variable "lt_name" {
  description = "Creates a name for launch template beginning with the specified prefix"
}
...
variable "ebs_dev_name_a" {
  description = "EBS device name (e.g. xvde)"
  default     = ""
}
variable "ebs_size_a" {
...
# variable "encryption_c" {
#   description = "EBS Volume Encryption"
#   default     = "true"
# }

variable "kms_key_id" {
  description = "EBS Volume KMS Key Id"
  default     = ""
}
